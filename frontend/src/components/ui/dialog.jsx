...
const DialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
 "fixed inset-0 z-50 bg-[hsla(221,38%,15%,0.4)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
 className
 )}
 {...props} />
))
