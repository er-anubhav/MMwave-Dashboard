...
export default function DeviceManagement() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9]">
      <main className="container px-6 py-12 mx-auto md:px-12">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-serif text-xl md:text-xl text-[#1C1917]">Device Management</h1>
                  <p className="text-sm text-[#78716C] mt-0.5">
                    Link and manage your MMWave devices
                  </p>
                </div>
              </div>
            </div>
          ...
          {devices.length === 0 ? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="mb-2 text-lg ">No devices linked</h3>
