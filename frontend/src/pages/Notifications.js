...
export default function Notifications() {
 ...
 className={`bg-white rounded-2xl border transition-all duration-300 overflow-hidden shadow-sm ${config.enabled ? ui.activeBorderColor + " shadow-md" : "border-gray-100"
 }`}
 >
 {/* Card Header */}
 ...
 className="flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-gray-800 border border-gray-200 px-5 py-2 rounded-lg text-sm transition-all disabled:opacity-70 disabled:cursor-not-allowed"
 >
 ...
 <div>
 <h3 className="text-base text-gray-900">Recent Notification Activity</h3>
