...
import { AlertCircle, CheckCircle2, Eye, EyeOff, ShieldCheck, Heart, Activity } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-background flex items-stretch justify-center relative isolate overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 dark:bg-zinc-950 text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="space-y-8 relative z-10 my-auto max-w-lg">
          ...
          >
            Create Your LYFSense Device Console.
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
          <Card className="rounded-2xl border-gray-200/60 dark:border-border/60 shadow-xl glass-card">
            <CardHeader className="space-y-1.5 pb-6">
              ...
              <CardTitle className="text-xl  text-black dark:text-primary">Create an Account</CardTitle>
              <CardDescription className="text-gray-500 dark:text-gray-400 text-sm">
                Get started today and configure your workspace.
              </CardDescription>
            </CardHeader>
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="name" className="text-xs  text-gray-700 dark:text-zinc-300">Full Name</Label>
                  <Input
                    id="name"
                    name="name"
                    type="text"
                ...
                <div className="space-y-1.5">
                  ...
                  {formData.password && (
                    <div className="text-xs space-y-1 mt-2 bg-emerald-50/30 dark:bg-emerald-950/10 p-2.5 rounded-lg border border-emerald-500/10">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="confirmPassword" className="text-xs  text-gray-700 dark:text-zinc-300">Confirm Password</Label>
                  <div className="relative">
                    <Input
                      id="confirmPassword"
...
function PasswordRequirement({ met, children }) {
  return (
    <div className={`flex items-center gap-2 ${met ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-gray-400 dark:text-zinc-500'}`}>
